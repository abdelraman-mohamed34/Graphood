...
export function CreateWorkspaceCard() {
    ...
    return (
        <Link href="/marketplace">
            <Button
                variant="ghost"
                className="group h-full w-full flex flex-col justify-between p-6 bg-card/40 border border-dashed border-border/60 rounded-2xl hover:border-primary/60 hover:bg-card/40 hover:shadow-[0_0_20px_-5px_rgba(0,0,0,0.1)] hover:-translate-y-0.5 transition-all duration-300 min-h-[160px]"
            >
                <div className="flex items-center justify-between w-full">
                    <ChevronLeft className="h-4 w-4 text-muted-foreground/40 group-hover:text-foreground group-hover:-translate-x-0.5 transition-all duration-300" />
